...
?>
<title>astra medical communications</title>
...
<div class="col-sm-3">
				<button type="button" id="rateProduct1" class="btn btn-info <?php if(!empty($_SESSION['userid']) && $_SESSION['userid']){ echo 'login';} ?>">Rate this </button>
			</div>		
		</div>
		<div class="row">
			<div class="col-sm-7">
	...
	<div class="modal fade" id="loginModal5" tabshow_rating="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
